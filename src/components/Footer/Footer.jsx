                  ...
                  <div className='relative'>
                    ...
                    <ul className='space-y-5 pt-5'>
                      <li>
                        <a
                          href='#'
                          className='text-primary hover:text-primary transition-colors font-noto font-normal'
                        >
                          Product Overview
                        </a>
                      </li>
                ...
                <div className='flex gap-16 w-full'>
                  <div className='relative'>
                    ...
                    <ul className='space-y-5 pt-5'>
                      <li>
                        <a
                          href='https://2fdzq6.share-eu1.hsforms.com/2FzkpEW-pQWuU0gkwVxvdbw?utm_source=website&utm_medium=footer&utm_campaign=investor'
                          className='text-primary hover:text-primary transition-colors font-noto font-normal'
                        >
                          Investor Newsletter
                        </a>
          ...
          <div className='flex items-center gap-20 relative sm:gap-5 sm:flex-col sm:text-center'>
            ...
            <ul className='space-x-5 flex pl-20 sm:pl-0'>
              <li>
                <a
                  href='#'
                  className='text-primary hover:text-primary transition-colors font-noto text-[12px] sm:text-[12px]'
                >
                  Privacy Policy
                </a>
              </li>
