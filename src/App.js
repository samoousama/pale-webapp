...
function App() {
  return (
    <div>
      <Header/>
      <div className="bg-herobanner bg-cover bg-center relative py-5 text-center pt-20">
        <div className='container max-auto'>
          <div className='flex-inline flex-col text-center '>
            <div className='inline-flex items-center justify-center bg-[#f5b89966] rounded-full font-sora text-[16px] text-darktext mx-auto relative px-[1px] pr-4'>
              <img 
                  src='/emoji.svg'
            ...
            <h3 className='text-center text-primary'>You allow the actions - I do the work</h3>
            <p className='font-noto text-[23px] text-[#00000099]'>AI Integrations without worries.</p>
      ...
      <div className='relative pb-20'>
        <div className='container mx-auto'>
          <div className='bg-[#F5B899] rounded-[24px] py-16 text-center'>
            ...
            <h3 className='text-center mx-auto'>I'm fluent in over <br/>
              <strong>100+</strong> Apps via MCP
            </h3>
            <div className='flex items-center justify-center pt-10 gap-7'>
      ...
      <div className="bg-white py-20 border-b-[1px] border-[#0000001a] border-b-[1px] relative overflow-hidden object-cover">
        ...
        <div className='container mx-auto text-center'>
          <h3 className='text-primary text-center'>I'm ready to prove myself - <strong className='block font-semibold text-[#0000004d]'>Are you?</strong></h3>
          <Button variant="primary" onClick={() => alert("Get Started")} className="py-[11px] px-7 mt-5">
              Get Started
          </Button>          
        </div>
